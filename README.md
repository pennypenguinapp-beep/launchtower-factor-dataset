# LaunchTower — 151-Stock Factor Dataset (Free Sample)
...
| File | Description |
|------|-------------|
| `data/factors_151_2026-09-16.csv` | **Full 151-stock factor table** — 14 columns, ranked by composite score |
| `data/factor_sample_151_2026-09-16.csv` | 15-row sample (top 10 + bottom 5) for quick inspection |
...
### Universe
151 US large/mid-cap equities spanning tech, healthcare, financials, energy, industrials, consumer staples, and materials. Tickers are listed in `data/factors_151_2026-09-16.csv`.
...
| Composite std | 0.463 |
| Composite range | −1.586 → +2.368 |
| Median composite | +0.098 |
| N positive | 88 (58%) |
| N negative | 63 (42%) |
| 12M return range | −59.2% → +597.7% |
| Ann. vol range | 18.4% → 192.2% |
